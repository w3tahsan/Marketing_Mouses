        ...
        <div class="page-wrapper">
            ...
            <footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
                <p class="text-muted text-center text-md-left">Copyright © 2024 <a href="https://www.nobleui.com"
                        target="_blank">MarketingMouses</a>. All rights reserved</p>
                <p class="text-muted text-center text-md-left mb-0 d-none d-md-block"><a target="_blank"
                        href="https://www.facebook.com/mahadi.tahsan">Developed By Tahsan</a></p>
            </footer>
            <!-- partial -->
        </div>
    </div>
